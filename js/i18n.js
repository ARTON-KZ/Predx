...
(function () {
  ...
  const T = {
    ...
    'pay-pass-label':  { es: 'Crea una Contraseña',  en: 'Create a Password' },
    'pay-pass-ph':     { es: 'Mínimo 6 caracteres',  en: 'At least 6 characters' },
    'pay-pass-error':  { es: 'La contraseña debe tener al menos 6 caracteres.', en: 'Password must be at least 6 characters.' },
    'pay-pass2-label': { es: 'Confirmar Contraseña', en: 'Confirm Password' },
    'pay-pass2-ph':    { es: 'Repite tu contraseña', en: 'Repeat your password' },
    'pay-pass2-error': { es: 'Las contraseñas no coinciden.', en: 'Passwords do not match.' },
    'pay-pass-hint':   { es: 'Guarda esta contraseña: la usarás con tu correo para acceder a tu cuenta después del pago, en cualquier dispositivo.', en: 'Save this password: you will use it with your email to access your account after payment, on any device.' },
    ...
    'suc-sub':        { es: 'Tu suscripción está activa. Te llevaremos a nuestro grupo privado de Telegram para que recibas tu código de acceso del administrador.', en: 'Your subscription is active. We will take you to our private Telegram group so you can get your access code from the admin.' },
    'suc-tg-btn':     { es: 'Unirse al Grupo VIP de Telegram', en: 'Join VIP Telegram Group' },
    'suc-tg-now':     { es: 'Ir a Telegram ahora', en: 'Go to Telegram now' },
    'suc-redirect-countdown': { es: 'Redirigiendo a Telegram en {n}s para recibir tu código de acceso…', en: 'Redirecting to Telegram in {n}s to get your access code…' },
    'suc-next-h':     { es: 'Próximo paso:', en: 'Next step:' },
    'suc-next-p': {
      es: 'El administrador te verificará en Telegram y te dará un <strong>código de acceso</strong>. Inicia sesión con tu <strong>correo, la contraseña que creaste al pagar y ese código</strong>.',
      en: "The admin will verify you on Telegram and give you an <strong>access code</strong>. Log in with your <strong>email, the password you created at checkout, and that code</strong>.",
    },
    ...
    'login-sub':         { es: 'Ingresa tu correo electrónico y la contraseña que creaste al pagar.', en: 'Enter your email address and the password you created at checkout.' },
